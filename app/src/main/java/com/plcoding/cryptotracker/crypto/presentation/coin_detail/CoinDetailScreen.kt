...
import com.plcoding.cryptotracker.crypto.presentation.coin_detail.components.InfoCardPreview
...
fun CoinDetailScreen(
    ...
    val contextColor = if (isSystemInDarkTheme()) {
        Color.White
    } else {
        Color.Black
    }
    ...
    if (state.isLoading) {
        ...
        Column(
            ...
            FlowRow(
                ...
                InfoCard(
                    title = stringResource(R.string.marker_cap),
